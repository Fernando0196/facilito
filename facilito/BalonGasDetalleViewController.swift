//
//  BalonGasDetalleViewController.swift
//  facilito
//
//  Created by iMac Mario on 28/08/23.
//
...
class BalonGasDetalleViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func mostrarViewReporte(_ sender: Any) {
        self.performSegue(withIdentifier: "sgReporte", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "sgReporte") {
            let vc = segue.destination as! ReportarBalonGasViewController
