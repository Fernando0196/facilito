//
//  ReportarBalonGasViewController.swift
//  facilito
//
//  Created by iMac Mario on 5/09/23.
//

import UIKit
import SwiftyJSON

class ReportarBalonGasViewController: UIViewController, UITextFieldDelegate {
    
    var vBalonDetalle: BalonGasDetalleViewController!
